...
export default defineConfig({
  ...
  use: {
    ...
    headless: false, //we can also use true for headless mode and false for headed mode
  },
  reporter: 'html', // we can also use 'line', 'list', 'html', 'json', 'junit', 'markdown', 'dot', 'json', 'html' and so on.
});
